About pytest-benchmark-feedstock
================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pytest-benchmark-feedstock/blob/main/LICENSE.txt)
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/pytest-benchmark-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/pytest-benchmark-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add pytest-benchmark
# for installing globally
pixi global install pytest-benchmark
```
...
It is possible to list all of the versions of `pytest-benchmark` available on your platform:
...
```
pixi search pytest-benchmark --channel conda-forge
```
